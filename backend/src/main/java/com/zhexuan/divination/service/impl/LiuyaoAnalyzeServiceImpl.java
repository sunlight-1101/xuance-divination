...
import com.zhexuan.divination.dto.LiuyaoYaoDTO;
...
public class LiuyaoAnalyzeServiceImpl implements LiuyaoAnalyzeService {
    ...
    public LiuyaoAnalyzeVO analyze(LiuyaoAnalyzeDTO dto) {
        ...
        DivinationRecord record = createPendingRecord(dto.getUserId(), dto.getQuestion(), inputJson, rules, classicReferences);
